defmodule BoggleTest do
  ...
  test "test_2b_given_4x4 " do
    ...
    board =
      {{"i", "s", "u", "o"}, {"o", "s", "v", "e"}, {"n", "e", "p", "a"}, {"n", "t", "s", "u"}}
  ...
  test "test_3c_large_8x8 " do
    ...
    board =
      {{"o", "c", "n", "e", "a", "s", "r", "a"}, {"c", "r", "i", "s", "h", "t", "i", "r"},
       {"l", "l", "a", "n", "n", "r", "e", "n"}, {"g", "e", "n", "s", "s", "a", "q", "n"},
       {"d", "a", "m", "c", "o", "b", "n", "u"}, {"n", "r", "o", "o", "s", "y", "e", "n"},
       {"a", "t", "s", "a", "r", "s", "o", "n"}, {"b", "e", "s", "s", "n", "n", "i", "s"}}
  ...
  def wordsInBoard?(found, board) do
    Enum.all?(
      for(
        entry <- Map.to_list(found),
        do: validate_word(board, entry) and validate_coords(entry)
      ),
      & &1
    )
  end
  ...
  def getScore(found) do
    ...
    s =
      for w <- words,
          do: if(String.length(w) <= 8, do: elem(w_scores, String.length(w) - 1), else: 20)
